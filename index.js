...
function getNumberFromString(s) {
  let n = parseFloat (s)
  return !isNaN(n) ? n : "Couldn't extract a number from the provided string"
...
function getIntegerFromString(s) {
  return !isNaN(parseInt(s)) ? parseInt(s) : "Couldn't extract a number from the provided string"
